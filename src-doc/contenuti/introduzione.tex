...
Nel seguente documento viene illustrato in modo dettagliato un prospetto di pianificazione e delle modalità attraverso le quali avverrà lo sviluppo del progetto. Il documento tratterà, in ordine, i seguenti punti:
\begin{itemize}
