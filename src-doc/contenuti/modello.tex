...
Il controllo di processo constente di attuare manutenzione migliorativa al proprio \textit{way of working} (da qui il "Principio del miglioramento continuo"). Il PDCA prevede un ciclo a 4 stadi per apportare specifiche migliorie a specifici processi:
\begin{itemize}
